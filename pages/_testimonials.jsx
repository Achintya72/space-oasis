...
export default function Testimonials() {
    return (
        <section className={styles.testimonials}>
            ...
            <p style={{ marginTop: "1rem", fontSize: "12px" }}><strong>Disclaimer:</strong> These people DO NOT exist, and did not say this. These quotes were generated by the SpaceOasis team for the purpose of website submission</p>
